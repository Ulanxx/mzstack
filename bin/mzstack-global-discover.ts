#!/usr/bin/env bun
/**
 * mzstack-global-discover — Discover AI coding sessions across Claude Code, Codex CLI, and Gemini CLI.
 ...
 *
 * Usage:
 *   mzstack-global-discover --since 7d [--format json|summary]
 *   mzstack-global-discover --help
 */
...
function printUsage(): void {
  console.error(`Usage: mzstack-global-discover --since <window> [--format json|summary]
...
Examples:
  mzstack-global-discover --since 7d
  mzstack-global-discover --since 14d --format summary`);
}
