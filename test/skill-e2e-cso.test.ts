...
- Save the report to .mzstack/security-reports/.`,
    ...
    const reportDir = path.join(csoDir, '.mzstack', 'security-reports');
...
- Skip the preamble (mzstack-update-check, telemetry, etc.) — go straight to the audit.
