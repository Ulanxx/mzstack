/**
 * mzstack browse server — persistent Chromium daemon
 *
 * Architecture:
 ...
 *
 * State:
 *   State file: <project-root>/.mzstack/browse.json (set via BROWSE_STATE_FILE env)
 *   Log files:  <project-root>/.mzstack/browse-{console,network,dialog}.log
...
function generateHelpText(): string {
  ...
  const lines = ['mzstack browse — headless browser for AI agents', '', 'Commands:'];
