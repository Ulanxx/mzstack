# mzstack — AI Engineering Workflow

mzstack is a collection of SKILL.md files that give AI agents structured roles for
...
| `/mzstack-upgrade` | Update mzstack to the latest version. |
